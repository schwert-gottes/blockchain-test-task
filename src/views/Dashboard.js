              ...
              <CardHeader>
                <Row>
                  <Col className="text-left" sm="6">
                    <h5 className="card-category">Player Total</h5>
                  </Col>
                  <Col sm="6">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted">
                            ...
                            personal data and privacy of Europe citizens for transactions that occur
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted">
                            Fifty percent of all respondents said they would be more likely to shop
                            at a company
                          </p>
                        </td>
                        <td className="td-actions text-right">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <p className="text-muted">
                            ...
                            once a breach exposing their personal data occurs.
                          </p>
                        </td>
                        <td className="td-actions text-right">
